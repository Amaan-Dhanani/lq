<script lang="ts">
	...
	let selected2 = tempquest.correctanswer_6 || 'A';
...
<div class="mr-[1rem] ml-[1rem] flex min-h-screen flex-col bg-[#4c4c61] dark:bg-[#1F1F39]">
	...
	>
		<h1 class="mb-[5px] text-center text-[18px] dark:text-white mb-4">Question 6</h1>
			...
			<Textarea
				id="answerchoicea_6"
				name="answerchoicea_6"
				required
				cap={1850}
				value={tempquest?.answerchoicea_6}
			...
			<Textarea
				id="answerchoiceb_6"
				name="answerchoiceb_6"
				required
				cap={1850}
				value={tempquest?.answerchoiceb_6}
			...
			<Textarea
				id="answerchoicec_6"
				name="answerchoicec_6"
				required
				cap={1850}
				value={tempquest?.answerchoicec_6}
			...
			<Textarea
				id="answerchoiced_6"
				name="answerchoiced_6"
				required
				cap={1850}
				value={tempquest?.answerchoiced_6}
			...
			<ImageSubmitter name="image_6" id="image_6" dataURI={tempquest?.image_6}/>

		<div class="gap-0">
			<h2 class="mt-[10px] mb-[5px] text-[16px] dark:text-white">Correct Answer</h2>
				<RadioHorizontal
					name="correctanswer_6"
