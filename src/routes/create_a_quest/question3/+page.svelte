<script lang="ts">
	...
	let selected2 = tempquest.correctanswer_3 || 'A';
	...
	>
		<h1 class="mb-[5px] text-center text-[18px] dark:text-white mb-4">Question 3</h1>
			...
			<Textarea
				...
				required
				cap={1850}
				value={tempquest?.answerchoicea_3}
			...
			<Textarea
				...
				required
				cap={1850}
				value={tempquest?.answerchoiceb_3}
			...
			<Textarea
				...
				required
				cap={1850}
				value={tempquest?.answerchoicec_3}
			...
			<Textarea
				...
				required
				cap={1850}
				value={tempquest?.answerchoiced_3}
			...
			<ImageSubmitter name="image_3" id="image_3" dataURI={tempquest?.image_3}/>

		<div class="gap-0">
			<h2 class="mt-[10px] mb-[5px] text-[16px] dark:text-white">Correct Answer</h2>
				<RadioHorizontal
					name="correctanswer_3"
