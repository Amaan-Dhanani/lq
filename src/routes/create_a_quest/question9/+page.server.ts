...
export const actions: Actions = {
    default: async ({ request, cookies }) => {
        ...
        //CHANGE
        const info = Object.fromEntries(formData) as { question_8: string; answerchoicea_8: string; answerchoiceb_8: string; answerchoicec_8: string; answerchoiced_8: string; description_8: string; image_8: string;};
        //CHANGE
