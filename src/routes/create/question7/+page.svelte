<script lang="ts">
	...
	let selected2 = tempquest.correctanswer_7 || 'A';
...
<div class="mr-[1rem] ml-[1rem] flex min-h-screen flex-col bg-[#4c4c61] dark:bg-[#1F1F39]">
	...
	>
		<h1 class="mb-[5px] text-center text-[18px] dark:text-white mb-4">Question 7</h1>
			...
			<Textarea
				id="answerchoicea_7"
				name="answerchoicea_7"
				required
				cap={1850}
				value={tempquest?.answerchoicea_7}
			...
			<Textarea
				id="answerchoiceb_7"
				name="answerchoiceb_7"
				required
				cap={1850}
				value={tempquest?.answerchoiceb_7}
			...
			<Textarea
				id="answerchoicec_7"
				name="answerchoicec_7"
				required
				cap={1850}
				value={tempquest?.answerchoicec_7}
			...
			<Textarea
				id="answerchoiced_7"
				name="answerchoiced_7"
				required
				cap={1850}
				value={tempquest?.answerchoiced_7}
			...
			<ImageSubmitter name="image_7" id="image_7" dataURI={tempquest?.image_7}/>

		<div class="gap-0">
			<h2 class="mt-[10px] mb-[5px] text-[16px] dark:text-white">Correct Answer</h2>
				<RadioHorizontal
					name="correctanswer_7"
