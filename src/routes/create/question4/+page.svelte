<script lang="ts">
	...
	let selected2 = tempquest.correctanswer_4 || 'A';
...
<div class="mr-[1rem] ml-[1rem] flex min-h-screen flex-col bg-[#4c4c61] dark:bg-[#1F1F39]">
	...
	>
		<h1 class="mb-[5px] text-center text-[18px] dark:text-white mb-4">Question 4</h1>
			...
			<Textarea
				id="answerchoicea_4"
				name="answerchoicea_4"
				required
				cap={1850}
				value={tempquest?.answerchoicea_4}
			...
			<Textarea
				id="answerchoiceb_4"
				name="answerchoiceb_4"
				required
				cap={1850}
				value={tempquest?.answerchoiceb_4}
			...
			<Textarea
				id="answerchoicec_4"
				name="answerchoicec_4"
				required
				cap={1850}
				value={tempquest?.answerchoicec_4}
			...
			<Textarea
				id="answerchoiced_4"
				name="answerchoiced_4"
				required
				cap={1850}
				value={tempquest?.answerchoiced_4}
			...
			<ImageSubmitter name="image_4" id="image_4" dataURI={tempquest?.image_4}/>

		<div class="gap-0">
			<h2 class="mt-[10px] mb-[5px] text-[16px] dark:text-white">Correct Answer</h2>
				<RadioHorizontal
					name="correctanswer_4"
